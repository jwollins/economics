...
# ggplot(yield_summary, aes(x = Year, y = mean_yield, color = Crop)) +
#   geom_line(size = 1) + 
...
#   theme_minimal()
# 
# ggplot(yield_sim_con, aes(x = Year, y = Yield, group = interaction(Crop, as.factor(run)))) +
#   geom_line(alpha = 0.05, aes(color = Crop)) +
